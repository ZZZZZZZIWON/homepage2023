...
public interface NaverLoginService {
	...
	// 네이버 아이디로 인증URI 생성 Method
	String getAuthorizationUrl (HttpSession session, String domain, String port);
	
	// 네이버 아이디로 Callback 처리 및 AccessToken 획득 Method
	OAuth2AccessToken getAccessToken (HttpSession session, String code, String domain, String state, String port ) throws IOException;
	...
	//Accesss Token을 이용하여 네이버 사용자 프로필 API를 호출
